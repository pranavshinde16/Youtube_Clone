  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black dark:bg-black">
      ...
      <div className="flex h-5 items-center">
        ...
        <div>
          <Link to="/" className="flex h-[22px] items-center">
            <img
              className="h-full desktopLogo"
              src={ytLogo}
              alt="Youtube"
            />
            <img
              className="h-full mobileLogo"
              src={ytLogoMobile}
              alt="Youtube"
            />
          </Link>
      ...
      <div className="flex items-center">
        <div className="hidden md:flex">
          ...
          <div className="flex items-center justify-center ml-2 h-12 w-12 rounded-full hover:bg-[#303030]/[0.6]">
