...
const VideoDetails = () => {
  ...
  return (
    ...
    <div className="flex justify-start flex-row h-[calc(100%-56px)] bg-black">
      <LeftNav/>
      <div className="w-full max-w-[1600px] flex flex-col lg:flex-row">
        {/* Video-Card Details */}
        <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
          <div className="h-[200px] md:h-[400px] lg:h-[700px] xl:h-[700px] ml-[-16px] lg:ml-0 mr-[-16px] lg:mr-0">
            <ReactPlayer
        ...
        {/* Suggestion Coloumn */}
        <div className="flex flex-col py-6 px-4 overflow-y-auto lg:w-[350px] xl:w-[400px] mt-4">
